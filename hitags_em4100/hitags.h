 ...
 * 82xx password unlock, then the page - because the tag drops the session after a write. This API
 * cannot read pages 4/5 or the resulting EM4100 emulation, so transmission is not proof of success
 * and callers must report the result as unverified until an external reader confirms it.
 *
